...
const post2 = await fetch('http://wordpress-a80wooocckwk0kwg4ow0c4o4.82.29.180.126.sslip.io/wp-json/wp/v2/posts?slug=magische-momente-am-mussbach-nachhaltige-weinwanderung');
const post3 = await fetch('http://wordpress-a80wooocckwk0kwg4ow0c4o4.82.29.180.126.sslip.io/wp-json/wp/v2/posts?slug=Von-Bacchus-bis-Christophorus');
const post4 = await fetch('http://wordpress-a80wooocckwk0kwg4ow0c4o4.82.29.180.126.sslip.io/wp-json/wp/v2/posts?slug=gluehwein-geheimnisvolles-gimmeldingen');
                  ...
                  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-[5%]">
                          ...
                          <AnimatePresence mode="wait">
                            <motion.div
                              ...
                              <p className="mt-4 max-w-3xl mx-auto text-xl md:text-2xl text-gray-100 font-body drop-shadow-sm"
                          ...
                          <div className="grid gap-1 md:gap-2 xl:gap-3 2xl:gap-4 grid-cols-1 sm:grid-cols-4 my-12 px-14 md:px-32
                          max-w-5xl mx-auto">
                            {tours.map((tour) => (
                              <motion.div
                                key={tour.id}
                              ...
                              >
                                <div className="relative w-full h-48 md:h-64 lg:h-72 overflow-hidden rounded-2xl">
                                  ...
                                  />
                                  <div className="absolute top-3 right-3 bg-stone-200/80 backdrop-blur-sm text-amber-900/90 font-semibold 
